  ...
  const renderItem = ({ item }) => (
    ...
    >
      ...
      <View style={styles.infoContainer}>
        ...
        <Text
          style={[styles.petBio, { color: isDarkMode ? "#D3D3D3" : "#6D4C41" }]}
        >
          {item.breed}
        </Text>
      </View>
      ...
      >
        <View
          style={[
            styles.header,
            {
              backgroundColor: isDarkMode ? "#333" : "#FFD700",
              borderBottomColor: isDarkMode ? "#555" : "#F0E68C",
            },
          ]}
        >
          <Image
              ...
              <View
                style={[
                  styles.bottomSheetContainer,
                  {
                    ...
                    borderColor: isDarkMode ? "#555" : "#F0E68C",
                  },
                ]}
              >
                ...
                <View style={styles.modalButtons}>
                  ...
                  <Button
                    ...
                    onPress={saveBio}
                    disabled={
                      editedBio.trim() === "" || editedBio === selectedPet?.bio
                    }
                  />
                </View>
              </View>
