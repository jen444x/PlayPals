...
export default function ForumsScreen({ navigation }) {
  ...
  const topics = ["All", "Training", "Toys", "Nutrition", "Health", "Behavior", "General"];
  ...
  const allPosts = [
    ...
    },
    {
      ...
      author: 'Diana',
      content: 'What are some common health problems in pets and how can I prevent them?',
      replyCount: 2,
      ...
      >
        <View style={styles.overlay}>
          <View style={styles.headerContainer}>
            <Image source={require('../assets/pawIcon.png')} style={styles.headerPaw} />
